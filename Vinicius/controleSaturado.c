...
#define SATURATION_RESPONSE_PERIOD 400.0
...
void PI_Control(MOTOR_PI* motorA){
    ...
    //apply control`s law
		(*motorA).controller_signal = A0*(*motorA).controller_signal+B0*((*motorA).errorK0speed)+B1*errorK1speed+C0*((*motorA).errorK0output)+C1*errorK1output;
